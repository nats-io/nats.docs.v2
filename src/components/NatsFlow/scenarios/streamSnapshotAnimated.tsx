...
const CAPTION: Record<Stage, string> = {
    ...
    config:
        "The server answers with the stream's config and state, then begins draining its store as an S2-compressed archive.",
    chunk:
...
function StreamSnapshotAnimatedInner({
    ...
    edges.push({
        ...
        data: {
            ...
            label: landed ? "backup.json + stream.arc.s2" : "to store",
