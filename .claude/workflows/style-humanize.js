...
3. Voice: second person, active voice, present tense, conversational and direct — a wise, warm, slightly witty guide ("Merlin/Gandalf type": to the point, opinionated, never stuffy). Welcoming like the Rust book. Don't sound like boilerplate enterprise copy, and don't flatten existing personality into corporate mush.
4. Orwell rules: cut a word if you can; short word over long word (use -> not utilize/leverage; big -> not extensive); no stock metaphors; no jargon where an everyday word works.
...
10. KILL AI-SLOP TICS where they appear: "It's important to note", "Note that", "In this section we will", "Let's dive in / delve", "seamless(ly)", "robust", "powerful", "leverage", "simply", "essentially", "Whether you're X or Y", formulaic rule-of-three sentence triads, the "It's not X. It's Y." rhetorical inversion when overused, every paragraph ending in a dramatic one-line fragment, over-bolded vocabulary (bold a term ONCE, where it's defined). Vary sentence and paragraph rhythm so the page reads written, not generated.
11. Do NOT convert straight quotes/apostrophes to curly typography (deliberate deviation: too risky in MDX).

VOICE CALIBRATION: first read docs/concepts/jetstream.md and docs/concepts/pub-sub-basics.md — match their plainness and warmth, then add the contractions and dash-diet they too lack.`
