...
not something a consumer does by default: the
[previous page](/learn/jetstream/delivery-and-acknowledgment) showed
that a redelivery arrives after later messages unless `MaxAckPending`
