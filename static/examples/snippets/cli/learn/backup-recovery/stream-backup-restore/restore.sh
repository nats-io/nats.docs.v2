...
# the archive back into JetStream and recreates the stream byte for
...
nats backup restore stream ./backups/orders/2026-06-04
...
#
# Restore reads either archive format, so a backup taken from an older
# server still restores.
