...
# drain timeout (default 30s), the remaining queued messages are discarded
# and the connection closes anyway, surfacing a drain-timeout error.
#
...
# snippet stands in for is the client tabs: size DrainTimeout to your
...
# timeout so a slow handshake does not get cut off mid-flush.
