...
- **Server** — the single [`nats-server`](https://github.com/nats-io/nats-server) binary. Clustering, JetStream, leaf nodes, [MQTT](/learn/mqtt/), and WebSocket are all configuration on the same process.
