...
| [`auth_callout`](./auth_callout/index.md) | Enables the auth callout functionality. All client connections requiring authentication will have their credentials pass-through to a dedicated auth service. | `object` | - | Yes |
