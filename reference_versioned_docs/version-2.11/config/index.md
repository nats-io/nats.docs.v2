...
| :--- | :---------- | :--- | :------ | :--------- |
| [`host`](./host.md) | Host for client connections. | `string` | `0.0.0.0` | Yes |
| [`port`](./port.md) | Port for client connections. Use `-1` for a random available port. | `integer` | `4222` | Yes |
| [`listen`](./listen.md) | `<host>:<port>` for a client connections. | `string` | - | Yes |
...
| [`allow_non_tls`](./allow_non_tls.md) | Allow mixed TLS and non-TLS on the same port. | `boolean` | - | Yes |
...
| Name | Description | Type | Default | Reloadable |
| :--- | :---------- | :--- | :------ | :--------- |
| [`operator`](./operator.md) | One or more operator JWTs, either in files or inlined. | `(multiple)` | - | Yes |
| [`trusted_keys`](./trusted_keys.md) | One or more operator public keys to trust. | `string` | - | Yes |
...
| [`system_account`](./system_account.md) | Name or public key of the account that will be deemed the *system* account. | `string` | `$SYS` | Yes |
| [`no_system_account`](./no_system_account.md) |  | `boolean` | - | Yes |
### Clustering

| Name | Description | Type | Default | Reloadable |
| :--- | :---------- | :--- | :------ | :--------- |
| [`cluster`](./cluster/index.md) | Configuration for clustering a set of servers. | `object` | - | Yes |
| [`gateway`](./gateway/index.md) | Configuration for setting up gateway connections between clusters. | `object` | - | No |
### Leafnodes

| Name | Description | Type | Default | Reloadable |
| :--- | :---------- | :--- | :------ | :--------- |
| [`leafnodes`](./leafnodes/index.md) | Configuration for setting up leaf node connections. | `object` | - | No |
### JetStream

| Name | Description | Type | Default | Reloadable |
| :--- | :---------- | :--- | :------ | :--------- |
| [`jetstream`](./jetstream/index.md) |  | `(multiple)` | `false` | No |
...
| [`logfile_size_limit`](./logfile_size_limit.md) | Size in bytes after the log file rolls over to a new one. | `integer` | `0` | Yes |
...
| Name | Description | Type | Default | Reloadable |
| :--- | :---------- | :--- | :------ | :--------- |
| [`server_name`](./server_name.md) | The servers name, shows up in logging. Defaults to the generated server ID. When JetStream is used, within a domain, all server names need to be unique. | `string` | - | Yes |
...
| [`http`](./http.md) | Listen specification `<host>:<port>` for server monitoring. | `string` | - | Yes |
| [`https`](./https.md) | Listen specification `<host>:<port>` for TLS server monitoring. | `string` | - | Yes |
| [`http_port`](./http_port.md) | HTTP port for server monitoring. | `integer` | - | Yes |
| [`https_port`](./https_port.md) | HTTPS port for server monitoring. | `integer` | - | Yes |
| [`http_base_path`](./http_base_path.md) | Base path for monitoring endpoints. | `string` | - | Yes |
...
| [`max_pending`](./max_pending.md) | Maximum number of bytes buffered for a connection Applies to client connections. Note that applications can also set `PendingLimits` (number of messages and total size) for their subscriptions. | `string` | `64MB` | Yes |
| [`max_subscriptions`](./max_subscriptions.md) | Maximum numbers of subscriptions per client and leafnode accounts connection. A value of `0` means unlimited. | `string` | `0` | Yes |
| [`max_subscription_tokens`](./max_subscription_tokens.md) |  | `integer` | - | Yes |
...
| [`no_header_support`](./no_header_support.md) | Disables support for message headers. | `boolean` | - | Yes |
| [`disable_sublist_cache`](./disable_sublist_cache.md) | If true, disable subscription caches for all accounts. This saves resources in situations where different subjects are used all the time. | `boolean` | `false` | Yes |
| [`lame_duck_duration`](./lame_duck_duration.md) | Must be at least 30s. | `duration` | `2m` | Yes |
| [`lame_duck_grace_period`](./lame_duck_grace_period.md) | This is the duration the server waits, after entering lame duck mode, before starting to close client connections | `duration` | `10s` | Yes |
| [`pidfile`](./pidfile.md) |  | `string` | - | Yes |
| [`ports_file_dir`](./ports_file_dir.md) |  | `string` | - | Yes |
| [`prof_port`](./prof_port.md) |  | `integer` | - | Yes |
| [`default_js_domain`](./default_js_domain.md) | Account to domain name mapping. | `string` | - | Yes |
