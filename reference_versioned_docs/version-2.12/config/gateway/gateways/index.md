...
| :--- | :---------- | :--- | :------ | :--------- |
| [`name`](/reference/config/gateway/gateways/name) | Name of the gateway being connected to. | `string` | - | Yes |
| [`url`](/reference/config/gateway/gateways/url) | A single URL to connect to. | `string` | - | Yes |
| [`urls`](/reference/config/gateway/gateways/urls) | A list of URLs to connect to (multiple servers in a cluster). | `string` | - | Yes |
