...
| `Nats-Stream-Identity` | String | JSStreamIdentity is the stream's identity used to reject consumer create on a mismatch, and return the stream identity in the consumer create/reset responses. |
