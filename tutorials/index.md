...
- **Tutorials** (you are here) show you *that* it works. Follow the steps and
  succeed in about 10–20 minutes.
- **[Learn](/learn/)** deep dives explain *why* it works — mechanisms, trade-offs,
  and the judgment to use NATS well.
...
If you want the *why* behind any of this — the mechanisms, the design choices, and
how to use NATS well — jump straight to the [Learn deep dives](/learn/).
