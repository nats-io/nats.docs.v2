...
const EXAMPLES_CONFIG = {
    ...
    "java": {
        ...
        branch: "doc-examples",
        directory: "src/examples/java/io/nats/examples/doc/",
        examples: {
            ...
            "subjects-single-wildcard": "SubjectsSingleWildcard",
            "subjects-multi-wildcard": "SubjectsMultiWildcard",
            "subjects-monitoring": "SubjectsMonitoring",
